...
from .views import active_resources
from .views import process_decision
...
class DataScienceResourceTest(TestCase):
    ...
    #     context = response.context_data["dsr_list"]
    #     self.assertEqual(len(context), 1)
    #     self.assertEqual(len(context[0]), 4)
    #     self.assertEqual(len(context[0][3]), N_USERS)
